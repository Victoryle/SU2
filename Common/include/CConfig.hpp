...
public:
  ...
  */
   ...
   * \param[in] val_ReThetaT_freestream - Value of the critical N-factor.
   */
...
/*!
  ...
  /*!
   * \brief Get Liu Wall Temperature temp.
   * \return Liu Wall Temperature.
   */
  su2double GetLiu_Twall(void) const { return Liu_Twall; }
