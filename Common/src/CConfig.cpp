...
void CConfig::SetConfig_Options() {
  ...
  /*!\brief SST_OPTIONS \n DESCRIPTION: */
  addDoubleOption("LIU_TWALL", Liu_Twall, 300.0);
          ...
          switch (aftParsedOptions.Correlation) {
            case AFT_CORRELATION::Liu2026:
              switch (Kind_Turb_Model) {
                ...
                case TURB_MODEL::SA: SU2_MPI::Error("SA turbulence model has been selected but AFT transition model is active.", CURRENT_FUNCTION); break;
              }
              cout << "-Liu2026" << endl;  break;
