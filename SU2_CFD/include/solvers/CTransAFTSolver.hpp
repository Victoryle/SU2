...
class CTransAFTSolver final : public CTurbSolver {
private:
...
public:
   ...
   */
  CTransAFTSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  ~CTransAFTSolver() = default;
 ...
 /*!
   ...
   */
  inline su2double GetAF1_Inf(void) const override { return Solution_Inf[0]; }

  /*!
   * \brief Get the value of the intermittency.
   * \return Value of the turbulent kinetic energy.
   */
  inline su2double GetAF2_Inf(void) const override { return Solution_Inf[1]; }
